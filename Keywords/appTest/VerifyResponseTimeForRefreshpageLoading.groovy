...
public class VerifyResponseTimeForRefreshpageLoading {
	...
	@Keyword
	def verifyResponseTimeForRefreshpageLoading(String element,String name,ExtentTest test){
		...
		(new support.Report()).getInstance().getResultStatus(LogStatus.INFO, name + " ResponseTime for Page load after refres: " + responseTime+" ms", image, test)
